...
\subsubsection[{\texorpdfstring{refract(const Vec3f \&incident, const Vec3f \&normal, const float \&refarction\+Index)}{refract(const Vec3f \&incident, const Vec3f \&normal, const float \&refarctionIndex)}}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Vec3f} refract (
\begin{DoxyParamCaption}
\item[{const {\bf Vec3f} \&}]{incident, }
\item[{const {\bf Vec3f} \&}]{normal, }
\item[{const float \&}]{refarction\+Index}
\end{DoxyParamCaption}
)}\hypertarget{group__linear__algebra_gaabecdc3e2c4f70f7330aaa6eae1300ac}{}\label{group__linear__algebra_gaabecdc3e2c4f70f7330aaa6eae1300ac}
